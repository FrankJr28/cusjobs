            ...
            <DefaultLayout>
                <Tabs defaultActiveKey="1" activeKey={activeTab}
                    items={[
                    {
                        ...
                        key: '1',
                        children: 
                            <Form initialValues={user} layout="vertical" onFinish={onPersonalInfoSubmit}>
                                <Row gutter={16}>
                                    <Col lg={8} sm={24}>
                                        ...
                                        {(education, {add , remove})=>(
                                            <div>
                                                {education.map((field, index)=>(
                                                    <div className="flex">
                                                        <Form.Item {...field} label='Education' style={{width:'80%'}} rules={[{required : true}]}>
                                                            <TextArea rows={4} />
                                                        </Form.Item>
                                        ...
                                        {(skills, {add , remove})=>(
                                            <div>
                                                {skills.map((field, index)=>(
                                                    <div className="flex">
                                                        <Form.Item {...field} label='Skills' style={{width:'80%'}} rules={[{required : true}]}>
                                                            <TextArea rows={4} />
                                                        </Form.Item>
                                                        <Button onClick={()=>{add()}}>Add more</Button>
                                                        {index !== 0 && (<Button onClick={()=>{remove(index)}}>Delete</Button>)}
                                        ...
                                        {(projects, {add , remove})=>(
                                            <div>
                                                {projects.map((field, index)=>(
                                                    <div className="flex">
                                                        <Form.Item {...field} label='Project' style={{width:'80%'}} rules={[{required : true}]}>
                                                            <TextArea rows={4} />
                                                        </Form.Item>
                                                        <Button onClick={()=>{add()}}>Add more</Button>
                                                        {index !== 0 && (<Button onClick={()=>{remove(index)}}>Delete</Button>)}
                                        ...
                                        {(experience, {add , remove})=>(
                                            <div>
                                                {experience.map((field, index)=>(
                                                    <div className="flex">
                                                        <Form.Item {...field} label='Experience' style={{width:'80%'}} rules={[{required : true}]}>
                                                            <TextArea rows={4} />
                                                        </Form.Item>
                                                        <Button onClick={()=>{add()}}>Add more</Button>
                                                        {index !== 0 && (<Button onClick={()=>{remove(index)}}>Delete</Button>)}
